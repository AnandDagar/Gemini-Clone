  ...
  return (
    <div className="h-screen flex">
      ...
      >
        ...
        <div className={`relative w-full ${open ? 'mb-16' : 'mb-0'} mt-auto transition-[margin] duration-500`}>
          <button className="relative w-full transition-[width] duration-300 h-10 overflow-hidden px-3 flex gap-4 items-center rounded-full hover:bg-sky-100 active:bg-sky-200">
            ...
            <span className={`absolute text-sm left-11 truncate transition-opacity duration-300 ${open ? 'opacity-100' : 'opacity-0'}`}>
              Help
            </span>
          </button>
